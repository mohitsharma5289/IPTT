...
2. "Security Clearance" scores 76 rather than 98, and keeps its late position
   just below RFS (confirmed 11 Sep 2026). The weight no longer implies a node
   is ~98% done on completing template task 39 (H6). Position and weight still
   disagree with the task template, which puts that activity at 39 of 50 -
   migration 0003 documents exactly what that costs.
...
REPORTING_STAGES: list[tuple[int, str, int, bool]] = [
    ...
    (17, "Testing Readiness", 78, False),
    (18, "Under Testing", 80, False),
    (19, "Validation & Testing Completed", 87, False),
    (20, "Under ATP", 89, False),
    (21, "ATP Acceptance", 93, False),
    (22, "IDC & NOC Handover WIP", 95, False),
    (23, "IDC & NOC Handover Completed", 97, False),
    # Confirmed 11 Sep 2026: weight lowered from 98 to 76, position left where the
    # legacy sequence had it. See migration 0003 for what this costs while template
    # task 39 still places the activity mid-pipeline.
    (24, "Security Clearance", 76, False),
    (25, "RFS", 99, False),
    (26, "Live", 100, True),
]
